...
<head>
    ...
    <!-- AutoNumeric -->
    <script src="<?= base_url('autoNumeric') ?>/src/AutoNumeric"></script>
    <!-- Terbilang -->
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <a href="<?= base_url('Penjualan/ResetCart') ?>" class="btn btn-flat btn-warning"><i class="fas fa-sync"> Reset</i></a>
                                                <a type="reset" class="btn btn-flat btn-success" data-toggle="modal" data-target="#pembayaran" onclick="Pembayaran()"><i class="fas fa-cash-register"></i> Pembayaran</a>
                                            </div>
                                        </div>
                                        <?php echo form_close() ?>
                                    </div>
                                                ...
                                                <?php foreach ($cart as $key => $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?= base_url('Penjualan/RemoveItemCart/' . $value['rowid']) ?>" class="btn btn-flat btn-danger btn-sm"><i class="fas fa-times"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php  } ?>
                                            </tbody>

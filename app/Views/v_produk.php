    ...
    <div class="card card-primary ">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button type="button" onclick="NewWin=window.open('<?= base_url('Laporan/PrintDataProduk') ?>','NewWin','toolbar=no, width=1100, height=600,scrollbars=yes')" class="btn btn-tool"><i class="fas fa-print"></i> Print
                </button>
